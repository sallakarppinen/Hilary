...
// This is to stop documentserver from triggering CSRF validation
OaeServer.addSafePathPrefix('/api/onlyoffice');

OAE.tenantRouter.on('post', '/api/onlyoffice', function(req, res) {
    log().info(req.body);
    return res.send(200, {'error': 0});
});
